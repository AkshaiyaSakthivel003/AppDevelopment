...
const MovieList = () => {
  ...
  const getData = useCallback(() => {   //b1a89f5ff7960aa54d49123a25d03503
    ...
    const popularTVShowsURL = `https://api.themoviedb.org/3/tv/popular?api_key=b1a89f5ff7960aa54d49123a25d03503&language=en-US`;
    ...
    const popularDramaURL = `https://api.themoviedb.org/3/discover/movie?api_key=b1a89f5ff7960aa54d49123a25d03503&language=en-US&sort_by=popularity.desc&with_genres=16&with_companies=2&primary_release_date.gte=2013-01-01`;
    ...
    Promise.all([movieRequest, tvShowRequest, streamRequest, kidRequest, dramaRequest])
      .then((results) => {
        const [movieData, tvShowData, streamData, kidData, dramaData] = results;
...
return (
  <div className="movie__list">
    ...
    <h2 className="list__title2">{(type ? type : "Popular Shows").toUpperCase()}</h2>
    <div className="list__cards">
